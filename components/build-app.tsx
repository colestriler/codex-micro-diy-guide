  ...
  return (
    <main id="top">
      ...
      <section id="assembly" className="build-section" aria-labelledby="heading-assembly">
          ...
          <p>The baffles in this animation are the older adhesive design. <a href="/downloads/baffle-snap-v1/guide.html">See the new clip-on baffle test</a> before printing or attaching cups.</p>
      ...
      <section id="files" className="build-section" aria-labelledby="heading-files">
          ...
          <div className="print-summary"><h3>New: clip-on light baffle — test two pieces</h3><p>Print one small plate sample and one matching cup. The plate has two flexible clips whose release tips are accessible underneath the cup. No glue or extra fasteners.</p><p>Use PETG, 100% scale and 0.10 mm layers. Test the empty cup first, then dry-fit a real switch and LED. Physical fit, repeated use and light leakage remain unverified.</p><p><a href="/downloads/stl/07_baffle_clip_test_plate_v1.stl" download>1. Test plate STL ↓</a> · <a href="/downloads/stl/07_snap_baffle_v1.stl" download>2. Cup STL ↓</a> · <a href="/downloads/baffle-snap-v1/guide.html" target="_blank" rel="noopener noreferrer">Print and release guide ↗</a></p><img src="/downloads/baffle-snap-v1/preview.png" alt="Clip-on baffle: plate clips enter the cup and their exposed tips can be pinched from underneath" style={{width:"100%",height:"auto"}}/><p>The combined full plate below includes the flat joystick mount and all twelve baffle clips. Wait for both fit tests. Its full-plate print orientation requires supports; the two small baffle test pieces use supports off.</p></div>
