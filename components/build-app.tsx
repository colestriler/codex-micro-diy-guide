  ...
  return (
    <main id="top">
      ...
      <section id="assembly" className="build-section" aria-labelledby="heading-assembly">
          ...
          <p>Joystick update: use the new screw-retained bench fit kit first. The original cradle and full keyboard animation are legacy geometry; the final top-plate attachment is not yet designed or physically verified. Keep your existing top plate until the sample fits. <a href="/downloads/joystick-fit-v1/guide.html" target="_blank" rel="noopener noreferrer">Open fit guide ↗</a></p>
      ...
      <section id="files" className="build-section" aria-labelledby="heading-files">
          ...
          <div className="print-summary"><h3>New: joystick fit-test kit</h3><p>Print the holder, shim A 0.5 mm and shim B 1.0 mm first. Use your existing PETG, 100% scale and no supports. This is a bench sample; do not reprint or drill the top plate yet.</p><p>To secure it: two M1.6 × 8 mm DIN 912 screws, two M1.6 DIN 934 nuts and a 1.5 mm hex key. You can check the initial fit without fasteners.</p><p><a href="/downloads/joystick-fit-v1/guide.html" target="_blank" rel="noopener noreferrer">Illustrated print and assembly guide ↗</a> · <a href="/downloads/joystick-fit-v1/joystick-fit-sample-v1.zip" download>Download complete fit kit ↓</a></p><img src="/downloads/joystick-fit-v1/preview.png" alt="New joystick holder and support shims, with a reference joystick secured by two screws" style={{width:"100%",height:"auto"}}/><p>The complete keyboard STEP, original CAD generator and animation still show the old cradle. The new kit has its own STEP files, source and validation report; physical fit remains to be tested.</p></div>
