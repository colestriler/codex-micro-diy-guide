  ...
  return (
    <main id="top">
      ...
      <section id="assembly" className="build-section" aria-labelledby="heading-assembly">
          ...
          <p>The baffles in this animation are the older adhesive design. <a href="/downloads/baffle-tray-v3/guide.html">See the new two-layer tray and its interactive CAD view</a> before printing.</p>
      ...
      <section id="files" className="build-section" aria-labelledby="heading-files">
          ...
          <div className="print-summary" id="current-cad"><h3>Current STEP files</h3><p>The latest set combines the flat joystick mount v3 with the heat-set baffle tray v3. The full upper plate includes both the joystick supports and the four tray screw holes. The upper plate and upper fit sample are unchanged from the two-layer v2 design.</p><div className="file-shortcuts"><a href="/downloads/current-cad/Codex-Micro-current-STEP.zip" download>Download current STEP set ↓</a><a href="/downloads/step/02_two_layer_top_plate_WAIT.step" download>Upper plate STEP — WAIT ↓</a><a href="/downloads/step/07_heatset_six_light_tray_v3_WAIT.step" download>Heat-set tray STEP — WAIT ↓</a><a href="/downloads/baffle-tray-v3/files/reference_assembly_NOT_PRINTABLE.step" download>Tray assembly STEP — view only ↓</a></div><p>The ZIP contains 13 current part and fit-sample STEP files, plus the partial tray assembly for reference. It excludes retired mounts, shims and baffles. Use the three small fit samples before printing the full-size pair; their individual STL and STEP links are below.</p></div>
