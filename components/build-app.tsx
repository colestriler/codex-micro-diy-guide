  ...
  return (
    <main id="top">
      ...
      <section id="assembly" className="build-section" aria-labelledby="heading-assembly">
          ...
          <p>Joystick v2: the mount is now integrated into a candidate top plate. Print the small test corner first; wait for its fit check before printing the full plate. This animation still shows the old mount. <a href="/downloads/joystick-integrated-v2/guide.html" target="_blank" rel="noopener noreferrer">Open v2 fit guide ↗</a></p>
      ...
      <section id="files" className="build-section" aria-labelledby="heading-files">
          ...
          <div className="print-summary"><h3>New: integrated joystick mount v2</h3><p>Print just the small test corner first—one piece, with both supports built in. It is cut from the same CAD as the candidate full top plate. No separate stand or shims.</p><p>Use existing PETG at 100% scale, 0.10 mm layers, visible face down. Support the shallow recess; follow the illustrated guide before slicing. The same two M1.6 × 8 mm screws, M1.6 nuts and 1.5 mm hex key are used.</p><p><a href="/downloads/stl/04_joystick_corner_v2_PRINT_FIRST.stl" download>Download the ONE test STL ↓</a> · <a href="/downloads/joystick-integrated-v2/guide.html" target="_blank" rel="noopener noreferrer">Print and fit guide ↗</a></p><img src="/downloads/joystick-integrated-v2/preview.png" alt="New integrated joystick test corner, screw-mounted joystick and underside nut pockets" style={{width:"100%",height:"auto"}}/><p>Wait to print the full plate until the corner fits. CAD checks pass; physical fit, strength and the real thumb cap’s full movement remain unverified. The full-keyboard animation and original assembly STEP still show the old mount.</p><p><a href="/downloads/joystick-integrated-v2/reference-kit-v2.zip" download>Complete v2 CAD/source kit ↓</a> · <a href="/downloads/joystick-fit-v1/guide.html">Previous bench holder v1 (archive)</a></p></div>
